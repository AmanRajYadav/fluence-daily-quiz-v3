...
/**
 * SAVED FOR RAPID FIRE MODE
 *
 * This component is preserved for the upcoming Rapid Fire game mode.
 * It displays three power-ups: 50:50, Blaster, and +30s Timer.
 *
 * Usage in Rapid Fire:
 * <RapidFirePowerUpBar
 *   powerUps={powerUps}
...
const RapidFirePowerUpBar = ({ powerUps, onUseFiftyFifty, onUseBlaster, onUseExtraTime, currentQuestionType }) => {
...
export default RapidFirePowerUpBar;
